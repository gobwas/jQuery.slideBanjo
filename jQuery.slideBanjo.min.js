...
captionToggle:!0,global_div:c(this).removeClass().addClass("sm_global"),naviST:!1,timeoutsY:[],timeoutsX:[],timeoutsC:[],winBlur:!1,ready:!1,userOptions:{navigationScrollTime:"auto",slideScrollTime:5E3,sliderEasing:"easeInBack",easing:"easeOutCirc",moveSpeed:700,sliderSpeed:500,loopX:"loop",blockEffect:"blind",blockEffectSpeed:300,hideMouseOver:!0,hideMouseTime:3E3,innerShadow:!0,loadingText:"\u0417\u0430\u0433\u0440\u0443\u0437\u043a\u0430 \u0441\u043b\u0430\u0439\u0434\u043e\u0432.",loadPause:!1}};
c.extend(a.userOptions,n);c(window).bind("blur",function(){a.winBlur=!0;for(var b in a.timeoutsX)clearTimeout(a.timeoutsX.shift());for(b in a.timeoutsY)clearTimeout(a.timeoutsY.shift());for(b in a.timeoutsC)clearTimeout(a.timeoutsC.shift());c(window).bind("focus",function(){c(window).unbind("focus");a.winBlur=!1;a.navigation.changeStatus=="auto"&&a.navigation.autoChange(!0);a.slide.changeStatus=="auto"&&a.slide.autoChange(a.slide.globalCounter,!0)})});a.draw=function(){this.banjo_div=c("<div/>").addClass("sm_banjo").appendTo(this.global_div).disableSelection();
...
"/"+String(this.total_loading));if(this.total_loaded==this.total_loading)this.loading_div.fadeOut(100,function(a){return function(){a.remove()}}(this.loading_div)),this.ready=!0};a.test=function(a){alert(a)};a.navigation.autoChange=function(b){if(!(this.changeStatus!="auto"||a.winBlur===!0)){if(a.current+1>=a.total||a.current==null)b||this.changeEffect(0);else if(!b)if(a.userOptions.loadPause===!0)if(a.ready===!0)this.changeEffect(a.current+1);else{for(var c in a.timeoutsY)clearTimeout(a.timeoutsY.shift());
b=setTimeout(function(){a.navigation.autoChange()},1E3);a.timeoutsY.push(b);return}else this.changeEffect(a.current+1);if(a.userOptions.navigationScrollTime=="auto"||a.naviST==!0)a.naviST=!0,a.userOptions.navigationScrollTime=Number(a.total_pic*a.userOptions.slideScrollTime);if(this.changeStatus=="auto"){for(c in a.timeoutsY)clearTimeout(a.timeoutsY.shift());b=setTimeout(function(){a.navigation.autoChange()},a.userOptions.navigationScrollTime);a.timeoutsY.push(b)}}};a.navigation.userChange=function(a){this.changeStatus=
"user";this.changeEffect(a)};a.navigation.changeEffect=function(b){a.slide.changeStatus="auto";a.current!=null&&(a.menus[a.current].removeClass("sm_menu_current"),a.articles[a.current].removeClass("sm_article_current"),a.abstracts[a.current].removeClass("sm_abstract_current"),a.arrows[a.current].removeClass("sm_arrow_current"));a.menus[b].stop(!1,!0).addClass("sm_menu_current");a.articles[b].addClass("sm_article_current");a.abstracts[b].addClass("sm_abstract_current");a.arrows[b].addClass("sm_arrow_current");
a.bottom.globalChange(b);a.navigation.slider&&a.navigation.slide(b);a.slide.captionChange(b,0);a.current!=b&&a.slide.globalChange(b);a.current=b;a.userOptions.hideMouseOver&&a.hideMouseFunc()};a.navigation.slide=function(b){var b=a.menus[b].position().top,g=null;if(b-a.temp.grid<=0){for(var d=0,g=c(".sm_slider").position().top;g-Math.round(d*this.kslider)>0&&b+d-a.temp.grid<0;)d+=1;g=Math.round(-d*this.kslider)}else b+a.temp.b+a.temp.grid>a.temp.c&&(d=a.temp.c-(b+a.temp.b+a.temp.grid),g=Math.round(-d*
this.kslider));g!=null&&(a.slider.stop().animate({top:a.slider.position().top+g+"px"},a.userOptions.sliderSpeed,a.userOptions.sliderEasing),a.global_div.find(".sm_menu").stop().animate({top:a.global_div.find(".sm_menu").position().top+d+"px"},a.userOptions.sliderSpeed,a.userOptions.sliderEasing))};a.slide.autoChange=function(b,c){if(!(a.slide.changeStatus!="auto"||b!=a.slide.globalCounter||a.winBlur===!0)){c||a.slide.changeEffect("right");if(this.changeStatus=="auto"){for(var d in a.timeoutsX)clearTimeout(a.timeoutsX.shift());
d=setTimeout(function(b){return function(){a.slide.autoChange(b)}}(b),a.userOptions.slideScrollTime);a.timeoutsX.push(d)}a.userOptions.hideMouseOver&&a.hideMouseFunc()}};a.slide.userChange=function(b,g){for(var d in a.timeoutsC)clearTimeout(a.timeoutsC.shift());c(g.target).attr("disabled","disabled");a.slide.changeStatus="user";a.navigation.changeStatus="user";d=function(a){return function(){c(a).removeAttr("disabled")}}(g.target);this.changeEffect(b,d)};a.slide.globalChange=function(b){a.total_pic=
a.slides[b].length;a.current_pic=0;a.slide.globalCounter+=1;for(var c in a.slides)for(var d in a.slides[c])a.slides[c][d].stop().animate({top:(c-b)*a.temp.slide.height+"px"},a.userOptions.moveSpeed,a.userOptions.easing,function(b,c){return function(){a.slides[b][c].animate({left:c*a.temp.slide.width+"px"},a.userOptions.moveSpeed/2,a.userOptions.easing)}}(c,d));a.total_pic<=1?a.slide.captionButtonsToggle(!1):(a.slide.captionButtonsToggle(!0),a.slide.autoChange(a.slide.globalCounter,!0))};a.slide.captionChange=
function(b,c){a.current!=null&&a.captions[a.current][a.current_pic].hide(0);a.captions[b][c].show("slide",a.userOptions.moveSpeed)};a.slide.captionButtonsToggle=function(b){b===!0?(a.left_div.removeAttr("disabled").fadeIn(a.userOptions.moveSpeed),a.right_div.removeAttr("disabled").fadeIn(a.userOptions.moveSpeed)):(a.left_div.attr("disabled","disabled").fadeOut(a.userOptions.moveSpeed),a.right_div.attr("disabled","disabled").fadeOut(a.userOptions.moveSpeed))};a.slide.captionToggle=function(b){b==void 0&&
(b=!a.captionToggle);b===!0?(a.slide_caption_div.stop().animate({left:"0px",opacity:1},a.userOptions.moveSpeed),a.captionToggle=!0):(a.slide_caption_div.stop().animate({left:-a.temp.captionHolder.width-5+"px",opacity:0.3},a.userOptions.moveSpeed),a.captionToggle=!1)};a.slide.changeEffect=function(b,c){var d=!1;b=="right"&&a.current_pic+1<a.total_pic&&(a.slide.captionChange(a.current,a.current_pic+1),a.current_pic+=1,d=!0);b=="left"&&a.current_pic-1>=0&&(a.slide.captionChange(a.current,a.current_pic-
1),a.current_pic-=1,d=!0);if(d)for(var e in a.slides[a.current])a.slides[a.current][e].animate({left:(e-a.current_pic)*a.temp.slide.width+"px"},a.userOptions.moveSpeed,a.userOptions.easing);else switch(a.userOptions.loopX){case "backward":for(e in a.slides[a.current])a.slides[a.current][e].animate({left:e*a.temp.slide.width+"px"},a.userOptions.moveSpeed,a.userOptions.easing);a.slide.captionChange(a.current,0);a.current_pic=0;break;case "loop":a.captions[a.current][a.current_pic].fadeOut(0);var d=
0,f=[],h=[];if(b=="left"){d=-1;zz=a.slides[a.current].length;for(e=a.slides[a.current].length-1;e>=0;e--)e!=a.current_pic?(d+=1,zz-=1,a.slides[a.current][e].css({left:1-zz*a.temp.slide.width+"px"}),f[d]=a.slides[a.current][e],h[d]=a.captions[a.current][e]):(a.slides[a.current][e].css({left:"0px"}),f[a.slides[a.current].length-1]=a.slides[a.current][e],h[a.slides[a.current].length-1]=a.captions[a.current][e]);a.current_pic=a.slides[a.current].length-1}else{for(e in a.slides[a.current])e!=a.current_pic?
(d+=1,a.slides[a.current][e].css({left:d*a.temp.slide.width+"px"}),f[d]=a.slides[a.current][e],h[d]=a.captions[a.current][e]):(a.slides[a.current][e].css({left:"0px"}),f[0]=a.slides[a.current][e],h[0]=a.captions[a.current][e]);a.current_pic=0}a.slides[a.current]=f;a.captions[a.current]=h;this.changeEffect(b);break;case "prohibit":return}typeof c=="function"&&setTimeout(c,a.userOptions.moveSpeed)};a.bottom.globalChange=function(b){a.current!=null&&(a.chs[a.current].hide(),a.contents[a.current].hide());
a.chs[b].show();a.contents[b].show()};a.hideMouseFunc=function(){a.slide_caption_div.stop().animate({opacity:1},function(){var b=setTimeout(function(){a.slide_caption_div.stop().animate({opacity:0})},a.userOptions.hideMouseTime);a.timeoutsC.push(b)})};a.draw();return this}})(jQuery);